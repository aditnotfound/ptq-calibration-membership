...
| output_logit_mse | 0.5107 | 0.0117 | 0.0000 |
| output_kl | 0.5923 | 0.0273 | 0.0273 |
| output_logprob | 0.5104 | 0.0000 | 0.0000 |
| output_logprob_gap | 0.5104 | 0.0000 | 0.0000 |
| output_combination | 0.5606 | 0.0234 | 0.0039 |

Selected artifact feature `artifact_reconstruction` minus selected output baseline `output_combination`: 0.4394 AUROC, crossed-bootstrap 95% interval [0.3675, 0.5172]. Both features were selected on shadow artifacts only. A negative value means artifact access buys nothing over ordinary output observation in this configuration.
...
|---|---:|---:|
| artifact_reconstruction | 0.7803 | 0.0312 |
| artifact_layer_combination | 1.0000 | 1.0000 |
| selected_artifact | 1.0000 | 1.0000 |
| selected_output | 0.5436 | 0.0195 |

Fixed-degree randomization test for the selected artifact score: p=0.000999 (1000 random assignments).

Full metrics and metadata:

```json
{
  "artifact_minus_output_combination_auroc": 0.439361572265625,
  "bits": 4,
  "calibration_size": 128,
  "candidate_generalization": {
    "artifact_minus_output_auroc": 0.456329345703125,
    "cluster_bootstrap": {
      "artifact_layer_combination": {
        "auroc": {
          "lower_95": 0.9997238805048116,
          "upper_95": 1.0
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.9715329570651079,
          "upper_95": 1.0
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.9839357429718876,
          "upper_95": 1.0
        }
      },
      "artifact_minus_selected_output_auroc": {
        "lower_95": 0.3792959023641373,
        "upper_95": 0.5331234426974292
      },
      "artifact_reconstruction": {
        "auroc": {
          "lower_95": 0.6889100283061307,
          "upper_95": 0.8777998397281006
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.019447798798395872,
          "upper_95": 0.27990804904051164
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.019447798798395872,
          "upper_95": 0.32094051021488296
        }
      },
      "output_combination": {
        "auroc": {
          "lower_95": 0.454001257204489,
          "upper_95": 0.6235933299251295
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.06226942676196212
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.08502436647173489
        }
      },
      "output_kl": {
        "auroc": {
          "lower_95": 0.4848988361014767,
          "upper_95": 0.6364932971640919
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.0887646627565982
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.12644893899204243
        }
      },
      "output_logit_mse": {
        "auroc": {
          "lower_95": 0.4565049207960221,
          "upper_95": 0.6079944716927185
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.04688422736220472
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.05971838918614473
        }
      },
      "output_logprob": {
        "auroc": {
          "lower_95": 0.4274464883635068,
          "upper_95": 0.5647230389559936
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.01626182180189149
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.024806465111413316
        }
      },
      "output_logprob_gap": {
        "auroc": {
          "lower_95": 0.4069003188529625,
          "upper_95": 0.5734612420440525
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.015749587625657462
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.02430404523705958
        }
      },
      "selected_artifact": {
        "auroc": {
      ...
      "selected_output": {
        "auroc": {
          "lower_95": 0.4668765573025708,
          "upper_95": 0.6207040976358627
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.056683612440191385
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.07987094179584672
        }
      }
    },
    "folds": 2,
    ...
    "selections": [
      {
        ...
        "output_validation_auroc": 0.5043243574802183,
      ...
      },
      {
        ...
        "output_validation_auroc": 0.5224498558547507,
        "selected_artifact_feature": "artifact_layer_combination",
  ...
  "cluster_bootstrap": {
    ...
    "artifact_minus_output_combination_auroc": {
      "lower_95": 0.36747008822298377,
      "upper_95": 0.5171659172981242
    },
    "artifact_reconstruction": {
      "auroc": {
        "lower_95": 0.9998626339524427,
        "upper_95": 1.0
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.9850173185773422,
        "upper_95": 1.0
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.9921259842519685,
        "upper_95": 1.0
      }
    },
    "output_combination": {
      "auroc": {
        "lower_95": 0.4826994979168892,
        "upper_95": 0.6325291487909941
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.09436208445642406
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.13941547269651708
      }
    },
    "output_kl": {
      "auroc": {
        "lower_95": 0.5156011384452,
        "upper_95": 0.6674898944581404
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.08462177121771218
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.0036467333831987827,
        "upper_95": 0.09226532455197968
      }
    },
    "output_logit_mse": {
      "auroc": {
        "lower_95": 0.4255702389745122,
        "upper_95": 0.5915570823826121
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.04477611940298507
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.090266757865937
      }
    },
    "output_logprob": {
      "auroc": {
        "lower_95": 0.4231901323264181,
        "upper_95": 0.5953049433731252
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.008164101706256272
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.02439273270283723
      }
    },
    "output_logprob_gap": {
      "auroc": {
  ...
  "fixed_degree_randomization_test": {
    "null_lower_95": 0.4494163513183594,
    "null_mean": 0.49894825744628907,
    "null_upper_95": 0.5526966094970703,
    "observed_auroc": 0.9999847412109375,
    "p_value_greater_equal": 0.000999000999000999,
    "replicates": 1000
  },
  "iters": 0,
  "layer_combination": {
  ...
  "mean_changed_weight_fraction_vs_artifact0": 0.20705997245594185,
  "metrics": {
    "artifact_layer_combination": {
      "auroc": 1.0,
      "tpr_at_0_1pct_fpr": 1.0,
    ...
    "output_combination": {
      "auroc": 0.5606231689453125,
      "tpr_at_0_1pct_fpr": 0.00390625,
      "tpr_at_1pct_fpr": 0.0234375
    },
    "output_kl": {
      "auroc": 0.5923309326171875,
      "tpr_at_0_1pct_fpr": 0.02734375,
      "tpr_at_1pct_fpr": 0.02734375
    },
    "output_logit_mse": {
      "auroc": 0.510650634765625,
      "tpr_at_0_1pct_fpr": 0.0,
      "tpr_at_1pct_fpr": 0.01171875
    },
    "output_logprob": {
      "auroc": 0.51043701171875,
      "tpr_at_0_1pct_fpr": 0.0,
      "tpr_at_1pct_fpr": 0.0
    },
    "output_logprob_gap": {
  ...
  "output_combination": {
    ...
    "regularization": 1.0,
    "shadow_split_auroc": 0.5838241577148438
  },
  ...
  "per_target_auroc": {
    ...
    "output_logit_mse": {
      ...
      "median": 0.515625,
      "minimum": 0.28125,
      "targets_above_chance": 17,
      "targets_at_least_0_9": 0,
      "upper_quartile": 0.59765625
    },
    "output_logprob": {
      "lower_quartile": 0.42578125,
      "maximum": 0.8125,
      "median": 0.515625,
      "minimum": 0.1875,
      "targets_above_chance": 17,
  ...
  "shadow_metrics": {
    ...
    "output_combination": {
      "auroc": 0.6222763061523438,
      "tpr_at_0_1pct_fpr": 0.01171875,
      "tpr_at_1pct_fpr": 0.068359375
    },
    "output_kl": {
      "auroc": 0.5812759399414062,
      "tpr_at_0_1pct_fpr": 0.0,
      "tpr_at_1pct_fpr": 0.021484375
    },
    "output_logit_mse": {
      "auroc": 0.5909080505371094,
      "tpr_at_0_1pct_fpr": 0.00390625,
      "tpr_at_1pct_fpr": 0.0390625
    },
    "output_logprob": {
      "auroc": 0.5869331359863281,
      "tpr_at_0_1pct_fpr": 0.0,
