...
|---|---:|---:|---:|
| artifact_reconstruction | 0.4343 | 0.0078 | 0.0000 |
| artifact_layer_combination | 0.7525 | 0.1406 | 0.0273 |
| output_logit_mse | 1.0000 | 1.0000 | 1.0000 |
| output_kl | 1.0000 | 1.0000 | 1.0000 |
| output_logprob | 0.7179 | 0.0000 | 0.0000 |
| output_logprob_gap | 0.7179 | 0.0000 | 0.0000 |
| output_combination | 1.0000 | 1.0000 | 1.0000 |

Selected artifact feature `artifact_layer_combination` minus selected output baseline `output_logit_mse`: -0.2475 AUROC, crossed-bootstrap 95% interval [-0.3326, -0.1547]. Both features were selected on shadow artifacts only. A negative value means artifact access buys nothing over ordinary output observation in this configuration.

## Layerwise localization

| Layer | AUROC | ROC TPR @ FPR<=1% |
|---|---:|---:|
| model.decoder.layers.0.fc1 | 0.6245 | 0.0703 |
| model.decoder.layers.0.self_attn.k_proj | 0.6144 | 0.0000 |
| model.decoder.layers.0.self_attn.v_proj | 0.5801 | 0.0469 |
| model.decoder.layers.9.self_attn.out_proj | 0.5793 | 0.0039 |
| model.decoder.layers.11.self_attn.out_proj | 0.5792 | 0.0039 |
| model.decoder.layers.2.self_attn.out_proj | 0.5514 | 0.0234 |
| model.decoder.layers.6.self_attn.out_proj | 0.5408 | 0.0078 |
| model.decoder.layers.9.self_attn.v_proj | 0.5400 | 0.0273 |
| model.decoder.layers.7.fc1 | 0.5396 | 0.0430 |
| model.decoder.layers.9.fc1 | 0.5339 | 0.0195 |
| model.decoder.layers.0.self_attn.q_proj | 0.5332 | 0.0117 |
| model.decoder.layers.5.fc1 | 0.5312 | 0.0117 |
...
|---|---:|---:|
| artifact_reconstruction | 0.4808 | 0.0156 |
| artifact_layer_combination | 0.5853 | 0.0312 |
| selected_artifact | 0.5853 | 0.0312 |
...
```json
{
  "artifact_minus_output_logit_mse_auroc": -0.2474517822265625,
  "bits": 4,
  "calibration_size": 128,
  "candidate_generalization": {
    "artifact_minus_output_auroc": -0.414703369140625,
    "cluster_bootstrap": {
      "artifact_layer_combination": {
        "auroc": {
          "lower_95": 0.5168239785443146,
          "upper_95": 0.6509993955241463
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.11338648528099908
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.004235522598870056,
          "upper_95": 0.13546154365588492
        }
      },
      "artifact_minus_selected_output_auroc": {
        "lower_95": -0.48317602145568533,
        "upper_95": -0.3490006044758537
      },
      "artifact_reconstruction": {
        "auroc": {
          "lower_95": 0.40768187192952493,
          "upper_95": 0.5622864462602053
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.04707282913165265
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.06717046788529263
        }
      },
      "output_combination": {
        "auroc": {
      ...
      "output_logprob": {
        "auroc": {
          "lower_95": 0.4352568517899688,
          "upper_95": 0.5948115271112888
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.09195402298850575
        },
        "tpr_at_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.0927004315239609
        }
      },
      "output_logprob_gap": {
        "auroc": {
          "lower_95": 0.4922509832239687,
          "upper_95": 0.6926143577869104
        },
        "tpr_at_0_1pct_fpr": {
          "lower_95": 0.0,
          "upper_95": 0.0
    ...
    "metrics": {
      ...
      "output_logprob": {
        "auroc": 0.508392333984375,
        "tpr_at_0_1pct_fpr": 0.0078125,
        "tpr_at_1pct_fpr": 0.03125
      },
      "output_logprob_gap": {
        "auroc": 0.5984649658203125,
    ...
    "selections": [
      {
        ...
        "layer_validation_auroc": 0.6531297709923665,
      ...
      },
      {
        ...
        "layer_regularization": 0.1,
        "layer_validation_auroc": 0.7044580152671756,
        "output_regularization": 1.0,
        "output_validation_auroc": 1.0,
        "selected_artifact_feature": "artifact_layer_combination",
  ...
  "cluster_bootstrap": {
    "artifact_layer_combination": {
      "auroc": {
        "lower_95": 0.6673555100702412,
        "upper_95": 0.8452547028242678
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.007935723696593261,
        "upper_95": 0.27239654002713704
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.016947364657083602,
        "upper_95": 0.34066776135741655
      }
    },
    "artifact_minus_output_logit_mse_auroc": {
      "lower_95": -0.33264448992975887,
      "upper_95": -0.15474529717573218
    },
    "artifact_reconstruction": {
      "auroc": {
        "lower_95": 0.34897331231020345,
        "upper_95": 0.5297018433219399
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.030086667049302632
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.04436120937762321
      }
    },
    "output_combination": {
      "auroc": {
    ...
    "output_logprob": {
      "auroc": {
        "lower_95": 0.6333410085362532,
        "upper_95": 0.7936131993311882
      },
      "tpr_at_0_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.02299071618037135
      },
      "tpr_at_1pct_fpr": {
        "lower_95": 0.0,
        "upper_95": 0.06088628762541805
      }
    },
    "output_logprob_gap": {
      "auroc": {
  ...
  "fixed_degree_randomization_test": {
    "null_lower_95": 0.4613162994384766,
    "null_mean": 0.4993581695556641,
    "null_upper_95": 0.5390392303466797,
    "observed_auroc": 0.7525482177734375,
  ...
  "mean_changed_weight_fraction_vs_artifact0": 0.7373123800219091,
  "metrics": {
    "artifact_layer_combination": {
      "auroc": 0.7525482177734375,
      "tpr_at_0_1pct_fpr": 0.02734375,
      "tpr_at_1pct_fpr": 0.140625
    },
    "artifact_reconstruction": {
      "auroc": 0.4343414306640625,
      "tpr_at_0_1pct_fpr": 0.0,
      "tpr_at_1pct_fpr": 0.0078125
    },
    "output_combination": {
  ...
  "per_target_auroc": {
    "artifact_layer_combination": {
      ...
      "upper_quartile": 0.859375
    },
    "artifact_reconstruction": {
      "lower_quartile": 0.3125,
      "maximum": 0.828125,
      "median": 0.390625,
      "minimum": 0.125,
      "targets_above_chance": 9,
      "targets_at_least_0_9": 0,
      "upper_quartile": 0.51953125
    },
    "output_combination": {
      "lower_quartile": 1.0,
      "maximum": 1.0,
  ...
  "shadow_calibrated_operating_points": {
    "artifact_layer_combination": {
      "1pct_target_fpr": {
        ...
        "test_fpr": 0.0234375,
        "test_tpr": 0.21875,
        "test_true_positives": 56,
        "threshold": 1.603937694723378
      }
    },
    "artifact_reconstruction": {
      "1pct_target_fpr": {
